...
/*     const handleSubmit = (e) => {
    ...
    return (
        ...
        <nav style= {{'background-color': "#090"}} className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div className="menu text-sm lg:flex-grow">
      ...
      <Link to= "/" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">Home page</Link>
